...
# See branches (branch is like google doc checkpoint, prevents conflict <- occurs when two people make changes on same thing): git branch
# Create new branch: git branch nameOfBranch
# Go to branch(when you create branch you are not in branch): git checkout nameOfBranch
# When Charlotte wants to make changes go ask Brian to help with pushing and merging <-- DO NOT DO ON OWN!!!!! VERY DANGEROUS
